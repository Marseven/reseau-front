...
import { ArrowLeft, Calendar, Building2, Server, Trash2 } from "lucide-react";
import { useZone, useDeleteZone } from "@/hooks/api";
...
export default function ZoneDetailPage() {
  ...
  const { data: zone, isLoading, isError } = useZone(id ? Number(id) : undefined);
